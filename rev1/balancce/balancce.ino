...
//    Serial.println(F("Initializing DMP..."));
    ...
    mpu.setXAccelOffset(5923); //5627
    mpu.setYAccelOffset(5937); //5893
    mpu.setZAccelOffset(9333); //9263
    mpu.setXGyroOffset(-31); // -30
    mpu.setYGyroOffset(-51); // -52
...
//     }
    ...
    balancePID.SetOutputLimits(-240, 240);         // match motor speed range
